...
namespace EchoBot.Models
{
    ...
    public class JoinInfo
    {
        ...
        /// <returns>Parsed data. ChatInfo is null for a short join URL, which carries no chat thread.</returns>
        ...
        private static bool TryParseShortJoinUrl(string joinURL, [NotNullWhen(true)] out JoinMeetingIdMeetingInfo? meetingInfo)
        {
            meetingInfo = null;
